...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'mithilesh.solanke@mitaoe.ac.in' ")
...
def TrackImages():
    ...
    while True:
        ...
        cv2.imshow('Capturing Face Data', im)
...
window.title("Face Recognition Tool")
window.configure(background='#F3D9E5')

frame1 = tk.Frame(window, bg="#C6BADE")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#C6BADE")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)

message3 = tk.Label(window, text="Face Recognition Tool Using CCTV" ,fg="white",bg="#4A3267" ,width=55 ,height=1,font=('comic', 29, ' bold '))
message3.place(x=0, y=0)

frame3 = tk.Frame(window, bg="#F5E6E8")
frame3.place(relx=0.52, rely=0.09, relwidth=0.09, relheight=0.07)

frame4 = tk.Frame(window, bg="#F5E6E8")
frame4.place(relx=0.36, rely=0.09, relwidth=0.16, relheight=0.07)

datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="#000000",bg="#F7B9C4" ,width=55 ,height=1,font=('comic', 22, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="#000000",bg="#F7B9C4" ,width=55 ,height=1,font=('comic', 22, ' bold '))
clock.pack(fill='both',expand=1)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="white",bg="#4A3267" ,font=('comic', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="white",bg="#4A3267" ,font=('comic', 17, ' bold ') )
head1.place(x=0,y=0)
...
lbl3 = tk.Label(frame1, text="Registered ID's",width=20  ,fg="black"  ,bg="#c79cff"  ,height=1 ,font=('comic', 17, ' bold '))
lbl3.place(x=100, y=105)
...
clearButton2.place(x=335, y=184)    
...
trackImg = tk.Button(frame1, text="Capture Face", command=TrackImages  ,fg="black"  ,bg="#3ffc00"  ,width=35  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
